...
def get_data():
    data = pd.read_csv('C:\\Users\\kmenezes\\Documents\\GitHub\\secret_dash\\projeto_dashh_helton\\dados/dados_pontos_selecionados.csv')
...
def get_usage_data(dados_filtrados):
    usage = pd.read_csv('C:\\Users\\kmenezes\\Documents\\GitHub\\secret_dash\\projeto_dashh_helton\\dados\\oct_hourly_use.csv')
    ...
    apps = pd.read_csv('C:\\Users\\kmenezes\\Documents\\GitHub\\secret_dash\\projeto_dashh_helton\\dados\\oct_apps_use.csv')
...
def main():
    ...
    # Load data
    data = get_data()
    st.sidebar.image("C:\\Users\\kmenezes\\Documents\\GitHub\\secret_dash\\projeto_dashh_helton\\int_vsat_TM_rgb_wht.png", width=100)
