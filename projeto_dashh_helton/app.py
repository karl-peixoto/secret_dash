...
def get_data():
    data = pd.read_csv('dados/dados_pontos_selecionados.csv')
...
def main():
    ...
    # Load data
    data = get_data()
    st.sidebar.image("C:\\Users\\kmenezes\OneDrive - Viasat, Inc\\viasat\\Situacional\\projeto_dashh_helton\\int_vsat_TM_rgb_wht.png", width=100)
